...
export const environment = {
  ...
  SellerDealsForTodayAPI: 'http://' + HOSTNAME + ':' + PORT_NUMBER + APPLICATION_NAME + 'DealsForTodayAPI-api',
  //CustomerDealsForTodayAPI: 'http://' + HOSTNAME + ':' + PORT_NUMBER + APPLICATION_NAME + '/CustomerDealsForTodayAPI'
};